...
namespace CryptoNote
{
	namespace parameters
	{
		...
		const uint64_t CRYPTONOTE_MAX_BLOCK_NUMBER = 1500000000;
		const size_t CRYPTONOTE_MAX_BLOCK_BLOB_SIZE = 1500000000;
		...
		const uint64_t MONEY_SUPPLY = UINT64_C(1500000000000000); /* max supply: 1.5b */
		...
		const uint64_t UPGRADE_HEIGHT_V8 = 130000000000;	  /* LWMA1 */
		const uint64_t UPGRADE_HEIGHT_V9 = 130000000001;	  /* LWMA1 */
	...
	const uint64_t GENESIS_TIMESTAMP = 1603105200;
	...
	const int P2P_DEFAULT_PORT = 21006;
	const int RPC_DEFAULT_PORT = 21016;
...
and the minimum version for communication between nodes */
	...
	const std::initializer_list<const char *> SEED_NODES = {
		"144.91.77.44:21006",	 // site
		"207.180.247.3:21006" //  node
	};
